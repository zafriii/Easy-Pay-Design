          ...
          <div className="space-y-8 pl-4 md:pl-16 lg:pl-24">
            ...
            <div>
              ...
              <div className="space-y-4">
                <h1
                  className="font-bold text-[44px] md:text-[56px] leading-[110%] text-[#01081B] text-left"
                  data-aos="fade-right"
                  data-aos-delay="200"
                >
                  <span className="block">
                    ...
                    <span className="relative inline-block">
                      Fast & Smarter
                      {/* SVG underline - decorative element */}
                      <svg
                        width="490"
                        height="12"
                        viewBox="0 0 490 12"
                        ...
                        className="absolute left-0 top-full -mt-1 w-[220px] md:w-[300px]"
                        aria-hidden="true"
                      >
                        <path
                  ...
                  <span className="block mt-2">from anywhere</span>
                </h1>
              </div>

              {/* Description */}
              <p
                className="text-[#4D525F] text-[18px] leading-[150%] font-normal max-w-md mt-4 mb-10"
                data-aos="fade-right"
                data-aos-delay="400"
              >
